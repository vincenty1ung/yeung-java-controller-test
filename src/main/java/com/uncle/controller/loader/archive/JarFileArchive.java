package com.uncle.controller.loader.archive;

import com.uncle.controller.loader.data.RandomAccessData;
import com.uncle.controller.loader.jar.JarFile;
...
public class JarFileArchive implements Archive {
    ...
    private final com.uncle.controller.loader.jar.JarFile jarFile;
    private URL url;
    ...
    public JarFileArchive(File file, URL url) throws IOException {
        this(new com.uncle.controller.loader.jar.JarFile(file));
        this.url = url;
    }

    public JarFileArchive(com.uncle.controller.loader.jar.JarFile jarFile) {
