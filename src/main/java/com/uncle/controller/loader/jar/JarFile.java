...
import com.uncle.controller.loader.data.RandomAccessData.ResourceAccess;
import com.uncle.controller.loader.data.RandomAccessDataFile;
...
public class JarFile extends java.util.jar.JarFile {
    ...
    @Override
    public com.uncle.controller.loader.jar.JarEntry getJarEntry(String name) {
        return (com.uncle.controller.loader.jar.JarEntry) this.getEntry(name);
    }
    ...
    public InputStream getInputStream(ZipEntry ze, ResourceAccess access) throws IOException {
        return ze instanceof com.uncle.controller.loader.jar.JarEntry ? this.entries.getInputStream((com.uncle.controller.loader.jar.JarEntry) ze, access) : this.getInputStream(ze != null ? ze.getName() : null, access);
    }
    ...
    public synchronized JarFile getNestedJarFile(ZipEntry entry) throws IOException {
        return this.getNestedJarFile((com.uncle.controller.loader.jar.JarEntry) entry);
    }

    public synchronized JarFile getNestedJarFile(com.uncle.controller.loader.jar.JarEntry entry) throws IOException {
        try {
    ...
    private JarFile createJarFileFromEntry(com.uncle.controller.loader.jar.JarEntry entry) throws IOException {
        return entry.isDirectory() ? this.createJarFileFromDirectoryEntry(entry) : this.createJarFileFromFileEntry(entry);
    }

    private JarFile createJarFileFromDirectoryEntry(com.uncle.controller.loader.jar.JarEntry entry) throws IOException {
    ...
    private JarFile createJarFileFromFileEntry(com.uncle.controller.loader.jar.JarEntry entry) throws IOException {
    ...
    void setupEntryCertificates(com.uncle.controller.loader.jar.JarEntry entry) {
        try {
    ...
    private void setCertificates(com.uncle.controller.loader.jar.JarEntry entry, JarEntry certEntry) {
        if (entry != null) {
