...
public class JarFileEntries
    ...
    public JarEntry getEntry(String name) {
        return (JarEntry) getEntry(name, com.uncle.controller.loader.jar.JarEntry.class, true);
    }
    ...
    private <T extends FileHeader> T getEntry(int index, Class<T> type, boolean cacheEntry) {
        try {
            ...
            if ((CentralDirectoryFileHeader.class.equals(entry.getClass())) &&
                ...
                entry = new com.uncle.controller.loader.jar.JarEntry(this.jarFile, (CentralDirectoryFileHeader) entry);
            }
    ...
    private class EntryIterator
        ...
        public JarEntry next() {
            ...
            this.index += 1;
            return (com.uncle.controller.loader.jar.JarEntry) JarFileEntries.this.getEntry(entryIndex, com.uncle.controller.loader.jar.JarEntry.class, false);
        }
    }
}
