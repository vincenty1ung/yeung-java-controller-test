...
import com.uncle.controller.loader.jar.Handler;
...
public class LaunchedURLClassLoader
    ...
    private void clearCache(URLConnection connection)
        ...
        if ((jarFile instanceof com.uncle.controller.loader.jar.JarFile)) {
            ((com.uncle.controller.loader.jar.JarFile) jarFile).clearCache();
        }
    }
